...
public class JobDao extends DAOImpl<JobRecord, jooq.generated.tables.pojos.Job, Integer> {
	 ...
	 */
	@Override
	protected Integer getId(jooq.generated.tables.pojos.Job object) {
	 ...
	 */
	public List<jooq.generated.tables.pojos.Job> fetchByJobId(Integer... values) {
	 ...
	 */
	public jooq.generated.tables.pojos.Job fetchOneByJobId(Integer value) {
