...
public class JobShortlistRecord extends UpdatableRecordImpl<JobShortlistRecord> implements Record3<Integer, Integer, Integer> {
	...
	private static final long serialVersionUID = -489789776;
	...
	/**
	 * Setter for <code>public.job_shortlist.user_id</code>.
	 */
	public JobShortlistRecord setUserId(Integer value) {
		setValue(2, value);
		return this;
	}

	/**
	 * Getter for <code>public.job_shortlist.user_id</code>.
	 */
	...
	public Field<Integer> field3() {
		return JobShortlist.JOB_SHORTLIST.USER_ID;
	}
	 ...
	 */
	public JobShortlistRecord(Integer jobShortlistId, Integer jobId, Integer userId) {
		super(JobShortlist.JOB_SHORTLIST);
