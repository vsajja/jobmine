...
public class LocationRecord extends UpdatableRecordImpl<LocationRecord> implements Record5<Integer, String, String, String, String> {

	private static final long serialVersionUID = -1529021916;
	 ...
	 */
	@Override
	public LocationRecord values(Integer value1, String value2, String value3, String value4, String value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public LocationRecord(Integer locationId, String city, String stateOrProvince, String zipOrPostalcode, String country) {
		super(Location.LOCATION);
