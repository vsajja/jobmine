...
public class ImageRecord extends UpdatableRecordImpl<ImageRecord> implements Record5<Integer, String, String, String, byte[]> {

	private static final long serialVersionUID = -1480656420;
	 ...
	 */
	@Override
	public ImageRecord values(Integer value1, String value2, String value3, String value4, byte[] value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ImageRecord(Integer imageId, String name, String src, String url, byte[] data) {
		super(Image.IMAGE);
